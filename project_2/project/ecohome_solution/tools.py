...
import requests                         # REST API for weather information
from geopy.geocoders import Nominatim   # Geographic location for weather API

# Load Base URL and API_KEY
    ...
    try:
        ...
        forecast = {
            ...
            "current": {
                ...
                "condition": _get_condition_string(current.get("weather_code")),
...
def search_energy_tips(query: str, max_results: int = 5) -> Dict[str, Any]:
    ...
    try:
        ...
        if not os.path.exists(os.path.join(persist_directory, "chroma.sqlite3")):
            ...
            # Create vector store
            embeddings = OpenAIEmbeddings(base_url=llm_base_url)
